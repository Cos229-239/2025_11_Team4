...
const Footer = () => {
  ...
  const hideFooterPages = ['/kitchen', '/kitchen-login', '/admin', '/admin/tables', '/scan-qr', '/restaurants'];
  ...
  return (
    <footer className="bg-dark-surface text-text-secondary mt-auto border-t border-dark-card">
      <div className="container mx-auto px-4 py-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-dark-card hover:bg-brand-orange rounded-lg flex items-center justify-center transition-colors"
                aria-label="Facebook"
              >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-dark-card mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-text-secondary">
              © {currentYear} OrderEasy. All rights reserved.
            </p>
