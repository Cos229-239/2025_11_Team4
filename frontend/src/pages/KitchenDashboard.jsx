                  ...
                  <div className="bg-dark-card/90 border-l-4 border-orange-400 rounded-2xl px-6 py-5 shadow-xl w-full max-w-2xl">
                    <div className="grid grid-cols-2 gap-y-2 text-sm">
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'all' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'manager' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'bartender' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'bar_back' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'busboy' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'waiter' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`col-span-2 flex items-center justify-between px-2 py-1 rounded-lg transition ${
                          selectedRole === 'hostess' ? 'bg-white/10' : 'hover:bg-white/5'
                        }`}
                      >
