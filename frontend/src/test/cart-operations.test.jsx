...
describe('Cart Operations - Detailed Tests', () => {
  ...
  describe('Adding Items to Cart', () => {
    ...
    it('should handle adding multiple different items', () => {
      ...
      expect(result.current.cartItemCount).toBe(4); // 1 + 2 + 1
    });
  ...
  describe('Cart Calculations', () => {
    it('should calculate subtotal correctly', () => {
      ...
      // 25.98 + 4.99 = 30.97
      expect(result.current.cartSubtotal).toBeCloseTo(30.97, 2);
    });
    ...
    it('should calculate item count correctly', () => {
      ...
      expect(result.current.cartItemCount).toBe(6); // 3 + 2 + 1
    });
    ...
    it('should calculate tax correctly', () => {
      ...
      expect(result.current.cartTotal).toBe(100.00);
    });
    ...
    it('should recalculate totals when items are removed', () => {
      ...
      expect(result.current.cartTotal).toBeCloseTo(17.98, 2);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large quantities', () => {
      ...
      expect(result.current.cartTotal).toBeCloseTo(12990, 2);
    });
    ...
    it('should handle decimal prices correctly', () => {
      ...
      expect(result.current.cartTotal).toBeCloseTo(29.97, 2);
    });
    ...
    it('should handle price as string', () => {
      ...
      expect(result.current.cartTotal).toBeCloseTo(15.99, 2);
    });
  });
});
